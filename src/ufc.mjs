...
function fightNotesByStage(source) {
  ...
  return { title: red && blue ? `${prefix}: ${red} v. ${blue}` : prefix, venue, localTime, notes: { "Main Card": fightNotes(main), Prelims: fightNotes(prelims), "Early Prelims": fightNotes(earlyPrelims) } };
}
